<?php
	...
	$image_fname = dirname(__FILE__) . '/banner02.png';
	...
	if (true) {
		...
		imagettftext_cr($image_new,10,0,$photoX/2,$photoY-4,imagecolorallocate($image_new,255,255,255),dirname(__FILE__).'/OpenSans-Regular.ttf',"Users online: $count_online  Games uploaded: $count_games (new: $count_games_today)"); //Archive size (YYG): $count_games_yyg
